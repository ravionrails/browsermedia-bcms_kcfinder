...
// @forked
// This has been altered from the original KCFinder path pattern to be more Rails like:
// Original used browse.php?act=COMMAND where as we use browse/COMMAND
browser.baseGetData = function(act) {
    var data = 'browse/'+ act +'?type=' + encodeURIComponent(this.type) + '&lng=' + this.lang;
    if (this.cms)
        data += "&cms=" + this.cms;
    return data;
};
